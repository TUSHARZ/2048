    ...
    for (var i = 0; i <= 3; i++) {
        for (var j = 0; j <= 3; j++) {
            ...
            if (v.rows[i].cells[j].innerHTML != " ") {
                ...
                switch (mycolor) {
                    case "2":
                        v.rows[i].cells[j].style.backgroundColor = "#6dcaec";
                        break;
                    case "4":
                        v.rows[i].cells[j].style.backgroundColor = "#24adde"
                        break;
                    case "8":
                        v.rows[i].cells[j].style.backgroundColor = "#cf9fe7"
                        break;
                    case "16":
                        v.rows[i].cells[j].style.backgroundColor = "#fc47c3"
                        break;
                    case "32":
                        v.rows[i].cells[j].style.backgroundColor = "#ff7979"
                        break;
                    case "64":
                        v.rows[i].cells[j].style.backgroundColor = "#f03131"
                        break
                    default:
                        v.rows[i].cells[j].style.backgroundColor = "#a8d324"

                }

            } else {
                v.rows[i].cells[j].style.backgroundColor = "#dddddd"
            }
        }
    }
...
function startthis() {
    ...
    v.rows[randi].cells[randj].style.backgroundColor = "#6dcaec";
    var td = v.rows[randi2].cells[randj2].innerHTML = "4";
    v.rows[randi2].cells[randj2].style.backgroundColor = "#24adde";
...
var gameover = function() {
    ...
    for (var i = 0; i <= 3; i++) {
        for (var j = 0; j <= 3; j++) {
            if (v.rows[i].cells[j].innerHTML != v.rows[i + 1].cells[j].innerHTML && v.rows[i].cells[j].innerHTML != v.rows[i].cells[j + 1].innerHTML && v.rows[i + 1].cells[j].innerHTML != " " && v.rows[i].cells[j + 1].innerHTML != " ") {
                k = k + 1;
                console.log("k = ", k);
            }
        }
